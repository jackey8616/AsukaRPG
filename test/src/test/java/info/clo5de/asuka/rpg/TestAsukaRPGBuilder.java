...
public class TestAsukaRPGBuilder {
    ...
    private ItemHandler itemHandler = mock(ItemHandler.class);
    private Handler recipeHandler = mock(Handler.class);
    ...
    public void setup () throws Exception {
        ...
        pdf = spy(new PluginDescriptionFile("AsukaRPG", "0.0.1",
                "info.clo5de.asuka.rpg.AsukaRPG"));
    ...
    private void declaredFields () throws Exception {
        ...
        //itemHandler = spy(new ItemHandler(asukaRPG));
        setFields(asukaRPG, AsukaRPG.class, "itemHandler", itemHandler);
        recipeHandler = spy(new info.clo5de.asuka.rpg.recipe.Handler(asukaRPG));
