package info.clo5de.asuka.rpg.version.v1_13_R1.item;
...
@PrepareForTest({ CraftItemStack.class, net.minecraft.server.v1_13_R1.ItemStack.class })
@PowerMockIgnore({"javax.management.*"})
public class TestItemNMSHandler {

    private static ItemNMSHandler itemNMSHandler;
    private static ItemStack mockStack;
    private static net.minecraft.server.v1_13_R1.ItemStack mockNMS;
    ...
    public static void setup () throws Exception {
        ...
        mockNMS = mock(net.minecraft.server.v1_13_R1.ItemStack.class);
