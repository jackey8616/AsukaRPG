...
public class TestOnPrepareCraft {
    ...
    public void resetAll (boolean first) throws Exception {
        if (first)
            return;
        reset(pice);
        reset(ing_1_1);
        ...
        reset(itemRecipe);
        reset(shaped);
        reset(ing_1_1_withoutMul);
        reset(ing_1_2_withoutMul);
        reset(recipeResultWithoutMulti);
        reset(itemRecipeWithoutMulti);
        reset(shapedWithoutMulti);
        map.clear();
        reset(handler);
        reset(craftInv);
        if (craftResult != null)
    ...
    @Test
    public void nothingFollowSystemRecipe () throws Exception {
        resetAll(true);
    ...
    @Test
    public void followButNoAsukaRecipes () throws Exception {
        resetAll(false);
        // Player crafting inventory
        craftInv = mock(CraftingInventory.class);
        when(pice.getInventory()).thenReturn(craftInv);
    ...
    @Test
    public void followButNoAsukaRecipesResultFound () throws Exception {
        resetAll(false);
        // Player crafting inventory
        craftInv = mock(CraftingInventory.class);
        when(pice.getInventory()).thenReturn(craftInv);
    ...
    @Test
    public void followAndAsukaRecipesResultFound () throws Exception {
        resetAll(false);
        // Player crafting inventory
        craftInv = mock(CraftingInventory.class);
        when(pice.getInventory()).thenReturn(craftInv);
